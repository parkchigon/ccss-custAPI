...
public class CustListServiceImpl implements CustListService 
{
	...
	@Override
	public ResponseJSON doService(HttpHeaders headers, RequestCustJSON reqJson, HttpServletRequest request) {
		ResponseJSON response = null;
		CheckResultData accessResult = access.doCheck(headers, reqJson, request);
