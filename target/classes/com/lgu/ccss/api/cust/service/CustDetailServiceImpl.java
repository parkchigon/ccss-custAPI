...
public class CustDetailServiceImpl implements CustDetailService 
{
	...
	@Override
	public ResponseJSON doService(HttpHeaders headers, RequestCustJSON req, HttpServletRequest request) 
	{
		 ...
		 */
		CheckResultData accessResult = access.doCheck(headers, req, request);
